...
public:
    Multiplication(int _id1, string _name1, int _id, string _name);
    void doForward();
    void doBackward();
};
...
public:
    Addition(int _id1, string _name1, int _id, string _name);
    void doForward();
    void doBackward();
};
...
public:
    Subtraction(int _id1,string _name1="",int _id,string _name);
    void doForward();
    void doBackward();
